...
phase3z %>% ggplot(aes(x=p3_assignedCond,y=p3_novel_zAcc,fill=p3_assignedCond))+geom_boxplot()
dTest3Novel %>% ggplot(aes(x=assignedCond,y=acc,fill=assignedCond))+geom_boxplot()

phase3z  %>% ggplot(aes(x=p3_assignedCond,y=p3_novel_zAcc,fill=p3_assignedCond))+geom_bar(stat="summary",position=dodge,fun.y="mean")+ stat_summary(fun.data=mean_se,geom="errorbar",position=dodge,width=.5)


dTestz %>% ggplot(aes(x=p3_assignedCond,y=p3_novel_zAcc))+geom_boxplot()
dTestz %>% ggplot(aes(x=p3_assignedCond,y=p3_novel_zAcc))+geom_bar(stat="summary",position=dodge,fun.y="mean")+ stat_summary(fun.data=mean_se,geom="errorbar",position=dodge,width=.5)
...
c1= dTestz %>% select(subjectID,p3_novel_zAcc)
c2= phase3z %>% select(subjectID,p3_novel_zAcc)
