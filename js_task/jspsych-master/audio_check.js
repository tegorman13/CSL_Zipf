...
jsPsych.plugins["audio-button-response-custom"] = (function () {
    var plugin = {};

    jsPsych.pluginAPI.registerPreload('audio-button-response-custom', 'stimulus', 'audio');

    plugin.info = {
        name: 'audio-button-response-custom',
        description: '',
        parameters: {
            stimulus: {
